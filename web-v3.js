...
<body>
  ...
  <div class="tab-content">
    ...
    <div class="tab-pane fade show active" id="dashboard">
      ...
      <button id="toggleRefresh" class="btn btn-sm btn-primary">⏸ Pause Auto Refresh</button>
    </div>
    ...
    <div class="tab-pane fade" id="report">
      <div class="row mb-3">
        ...
        <div class="col-md-3 d-flex align-items-end">
          ...
          <a id="export" class="btn btn-success">Export Excel</a>
        </div>
      </div>
